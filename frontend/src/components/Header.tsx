    ...
    <header className='flex justify-between items-center relative !p-5'>
      ...
      <div className='flex w-[210px] justify-between items-center'>
        ...
        <div className='flex items-center font-brygada hover:underline gap-2'>
          ...
          <p className='flex font-brygada hover:underline font-normal text-xl'>Log in</p>
        </div>
        <div className='flex items-center flex-col'>
          <p className='flex font-brygada hover:underline font-normal text-xl '>EN</p>
          <p className='flex font-brygada hover:underline font-normal text-xl'>UA</p>
        </div>
      </div>
